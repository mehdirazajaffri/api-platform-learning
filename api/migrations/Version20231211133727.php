 ...
 */
final class Version20231211133727 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dragon_treasure (id INT NOT NULL, owner_id INT NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, value INT DEFAULT NULL, cool_factor INT DEFAULT NULL, plunder_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, is_published BOOLEAN DEFAULT NULL, PRIMARY KEY(id))');
